...
brainq_contaminacion<-read.table(file="brainq_contaminacion.tsv", header = TRUE, 
                                 sep = "\t")
...
grid.arrange(m1,m2,m3,m6, nrow=2)
grid.arrange(m7,m8,m9,m12, nrow=2)
grid.arrange(m10,m11,nrow=1)

grid.arrange(m1,m3, ncol=2)

grid.arrange(m1,m2,m3,m5,m6,m7,m8,m9,m10,m11,m12, ncol=2)
